...
const Demo2Banner2 = () => {
  return (
    <section id="banner-2" className="pt-50 bg-white banner-section division">
            ...
            <div className="col-lg-6 offset-lg-1">
              ...
              >
                ...
                <p>
                  ...
                  laoreet gestas neque undo luctus feugiat. Aliquam a augue
                  suscipit
                </p>
                {/* Button */}
